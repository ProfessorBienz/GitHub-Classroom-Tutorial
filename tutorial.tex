...
\begin{enumerate}
    ...
    \item \textbf{Update Compile Script.}  Add all configuration and compilation commands to the file `compile.sh`.  This is the file that GitHub Classroom will use to compile your code.  \emph{If you need further direction on this step, check down in hints.}
