...
\begin{enumerate} 
    ...
    \item \textbf{Move into the folder you just checked out}.  You should be able to see the folder you just checked out with the command `ls'.  You can enter this folder with `cd foldername', where foldername is the name of your new folder.
    
    \item \textbf{Pull submodule updates.}  Initial code, configuration, and testing environments are provided for you in a separate GitHub repository, linked as a submodule.  You cannot change this code.  Make sure to pull the latest updatesto this submodule with the following:
    \begin{enumerate}
